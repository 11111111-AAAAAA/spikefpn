...
def parse_args():
    ...
    parser.add_argument("-rp", "--root_path", type=str, default="/kaggle/input/ncars-dataset/original")
    parser.add_argument("-sp", "--save_path", type=str, default="/kaggle/input/ncars-dataset/")
